...
****************************************************************************************** */
    ...
    var sceneM;
    function setup(){
        sceneM = new Scenes({stats:true});
        $(sceneM).bind(sceneM.EVENT_DELETE_SCROLL, scrollDel);
        sceneM.addScene(0,1000,'normal',{ease:'easeInOutBack',duration:5000});
        sceneM.addScene(1,1000,'quick',{ease:'easeInOutBack',duration:5000});
        sceneM.addScene(2,1000,'normal',{ease:'easeInOutBack',duration:5000});
    ...
    function onScroll(offset){
        ...
        // if(!mns && sceneM)sceneM.update(offset);
    ...
    function cloudMove(offset){
        ...
        var newP;
        if(introOffset.p <= 0.3){
            newP = introOffset.p/0.3;
        }else{
            newP = 1;
        }
